...
t.advantage[t.advantage.length] = [i.name, 1, "feather-alt", function() {
	t.damage.zephyr_strike = { dice: [[1, 8]], label:`Force Damage - ${i.name}`
};}];
...
i.roll({configureDialog: false, createMessage: false});